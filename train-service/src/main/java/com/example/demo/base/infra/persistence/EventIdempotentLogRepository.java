...
import com.example.demo.base.shared.entity.EventIdempotentLogId;
...
public interface EventIdempotentLogRepository extends JpaRepository<EventIdempotentLog, EventIdempotentLogId> {
	...
	@Modifying
	@Query(value = "INSERT IGNORE INTO EVENT_IDEMPOTENT_LOG (event_type, unique_key, target_id, created_date) VALUES (:eventType, :uniqueKey, :targetId, NOW())", nativeQuery = true)
